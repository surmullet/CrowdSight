...
**MOT20 acquisition/evaluation note (2026-09-26):** following product-lead authorization, official video and label archives were downloaded to private storage, CRC-checked, and used for exploratory MOT20-05 evaluation. Exact hashes and private location are in the diagnostic report. Current official archive page omits license terms; historical terms are unauthenticated. Human review and complete checkpoint lineage review remain required. No assets or results are in Git; this is not held-out evidence.
