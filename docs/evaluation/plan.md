...
| Crowd held-out evaluation | Versioned manifest, manual labels/predictions format, inference runner, scorer, and independence/permission gates are implemented. No approved held-out test set is ready: Plaza overlaps training; `best.pt` was previously measured on the six-sequence DroneCrowd comparison; the DroneCrowd challenge annotations are absent; and `heat_map/data/videos/test.mp4` has no reviewed labels. A separately selected, nearly fixed overhead Mixkit intersection video is available in `../uav-crowd-monitoring/artifacts/independent-intersection/` with SHA-256 `e9084a41628e578d45f356e1a9ae1bfb6ad182f3786d09ad4f965aab259fe6a1`; it was not used in E01 fine-tuning, but has no manual labels and source independence from upstream pretraining has not been reviewed. It is sparse pedestrian traffic, not dense-crowd evidence. | Dataset owner records the license/permission review, then lock a video-level sample and obtain complete manual labels. Verify the full training inventory and independence evidence; run the pinned inference and scorer; reviewer authenticates referenced permission/independence evidence before any held-out claim. See [candidate video sources](candidate-video-sources.md). |
